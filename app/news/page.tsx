...
const news = [
  ...
  {date: "2026/08/12",
    category: "Conference Presentation",
    tone: "conference",
    summary: "Kishan Dhakal presented his work on PS-InSAR deformation monitoring of tailing dams at the 2026 IGARSS conference in Washington, D.C.",
  },
   {date: "2026/08/01",
    category: "Conference Presentation",
    tone: "conference",
    summary: "Kishan Dhakal completed the 5-day CLaSH 2026 Field School at CSU's Mountain Campus, learning post-disaster reconnaissance methods including GPS/GNSS, photogrammetry, LiDAR drone surveys, and Structure from Motion at the 2020 Cameron Peak Fire burn site.",
  },
   {date: "2026/03/27",
